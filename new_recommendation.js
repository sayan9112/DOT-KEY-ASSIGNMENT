...
readline.question('Enter a product name: ', (product_name) =>  {
  readline.question('Enter a product rating: ', (product_rating) => {
      console.log(recommendProduct(product_name, parseFloat(product_rating)))
      readline.close()
  })
})